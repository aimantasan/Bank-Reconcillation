  ...
  <div>
    <div class="flex justify-between items-start">
      <div class="text-2xl p-3 font-semibold">
        Unrefined Data from Bank Statement 
      </div>
      <hr>
    </div>
    <rs-card class="p-2">
        ...
        <rs-card class="flex-1 p-1 justify-center">
          <div class="text-center p-4">
            ...
            <div class="flex justify-center">
              <img src="@/assets/img/indicator/A.png" class="max-w-[80%]" />
            </div>
          </div>
        </rs-card>
        ...
        <form v-if="selectedTransaction">
          <div class="grid grid-cols-4 gap-4">
            ...
            <div class="col-span-1">
              <label class="block text-sm font-bold mb-2">Amount (RM):</label>
              <input type="text" v-model="selectedTransaction['Amount (RM)']" class="border rounded-md w-full p-2" disabled>
            </div>

            <!-- Company Name -->
            <div class="col-span-3">
              <label class="block text-sm font-bold mb-2">Company Name:</label>
              <input type="text" v-model="selectedTransaction['Company Name']" class="border rounded-md w-full p-2" disabled>
            </div>
