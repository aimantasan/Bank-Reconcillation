  ...
  <div>
    <div class="flex justify-between items-start">
      <div class="text-2xl p-3 font-semibold">
        Unrefined Data from Settlement Data 
      </div>
      <hr>
    </div>
    <rs-card class="p-2">
        ...
        <rs-card class="flex-1 p-1 justify-center">
          <div class="text-center p-4">
            ...
            <div class="flex justify-center">
              <img src="@/assets/img/indicator/BB.png" class="max-w-[80%]" />
            </div>
          </div>
        </rs-card>
        ...
        <form v-if="selectedTransaction">
          <div class="grid grid-cols-4 gap-4">
            ...
            <div class="col-span-4">
              <label class="block text-sm font-bold mb-2">Reference:</label>
              <input type="text" v-model="selectedTransaction.Reference" class="border rounded-md w-full p-2" disabled>
            </div>
