...
const data = [
  {
    "Recipient Reference No":"TP03375409293104021219",
  ...
  <div>
    <div class="flex justify-between items-start">
      <div class="text-2xl p-3 font-semibold">
        Unrefined Data from Bank Statement Debit 
      </div>
      <hr>
    </div>
    <rs-card class="p-2">
        ...
        <rs-card class="flex-1 p-1 justify-center">
          <div class="text-center p-4">
            ...
            <div class="flex justify-center">
              <img src="@/assets/img/indicator/AA.png" class="max-w-[80%]" />
            </div>
          </div>
        </rs-card>
      ...
      <div class="p-4">
        <form v-if="selectedTransaction">
          <div class="grid grid-cols-4 gap-4">
            ...
            <!-- Reference No -->
            <div class="col-span-2">
              <label class="block text-sm font-bold mb-2">Recipient Reference No:</label>
              <input type="text" v-model="selectedTransaction['Recipient Reference No']" class="border rounded-md w-full p-2" disabled>
            </div>
