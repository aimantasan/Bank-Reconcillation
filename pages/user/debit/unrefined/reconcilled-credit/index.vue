...
const data = [
  {
    ...
    "Description":"FPX Credit",
    "Amount In(RM)":"1391.00",
    "Amount Out(RM)":"1391.00",
    "Amount Nett(RM)":"1391.00",
    "Name":"Buyer1234",
    "Email":"Buyer1234@email.com",
    "Reference":"Payment to User",
  ...
  <div>
    <div class="flex justify-between items-start">
      <div class="text-2xl p-3 font-semibold">
        Unrefined Data from Reconcilled Credit Data 
      </div>
      <hr>
    </div>
    <rs-card class="p-2">
        ...
        <rs-card class="flex-1 p-1 justify-center">
          <div class="text-center p-4">
            ...
            <div class="flex justify-center">
              <img src="@/assets/img/indicator/CC.png" class="max-w-[80%]" />
            </div>
          </div>
        </rs-card>
          ...
          <div class="grid grid-cols-4 gap-4">
            ...
            <div class="col-span-1 flex items-center">
             ...
             <div class="col-span-2">
              ...
              <input type="text" v-model="selectedTransaction.TransactionID" class="border rounded-md w-full p-2" disabled>
            </div>

            <!-- Reference No -->
            <div class="col-span-2">
              <label class="block text-sm font-bold mb-2">Reference No:</label>
              <input type="text" v-model="selectedTransaction['Reference No']" class="border rounded-md w-full p-2" disabled>
            </div>

            <!-- Description -->
            <div class="col-span-4">
              <label class="block text-sm font-bold mb-2">Description:</label>
              <input type="text" v-model="selectedTransaction.Description" class="border rounded-md w-full p-2" disabled>
            </div>
            ...
            <div class="col-span-2">
             ...
             <div class="col-span-1">
              <label class="block text-sm font-bold mb-2">Amount In (RM):</label>
              <input type="text" v-model="selectedTransaction['Amount In(RM)']" class="border rounded-md w-full p-2" disabled>
            </div>
             <!-- Amount -->
             <div class="col-span-1">
              <label class="block text-sm font-bold mb-2">Amount Out (RM):</label>
              <input type="text" v-model="selectedTransaction['Amount Out(RM)']" class="border rounded-md w-full p-2" disabled>
            </div>
             <!-- Amount -->
             <div class="col-span-1">
