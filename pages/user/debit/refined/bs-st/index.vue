<script setup>
definePageMeta({
  title: "Bank Statement Debit & Settlement", 
  middleware: ["auth"],
  requiresAuth: true,
});
...
const data = [
  {
    ...
    "Payment Reference No":"TP03375409293104021219",
    "Description":"FPX Debit",
    "Amount Out(RM)":"1391.00",
    "Amount (RM)":"1391.00",
    "Amount Nett(RM)":"1391.00",
    "Settlement Reference":"Payment to user",
    "Name":"Buyer1234",
  ...
  <div>
    <div class="flex justify-between items-start">
      <div class="text-2xl p-3 font-semibold">
        Refined Data from Debit Bank Statement & Settlement 
      </div>
      <hr>
    </div>
    <rs-card class="p-2">
        ...
        <rs-card class="flex-1 p-1 justify-center">
          <div class="text-center p-4">
            ...
            <div class="flex justify-center">
              <img src="@/assets/img/indicator/DD.png" class="max-w-[80%]" />
            </div>
          </div>
        </rs-card>
